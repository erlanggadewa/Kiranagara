...
alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].data("adminAuth", function () {
  return {
    onVal: JSON.parse(localStorage.getItem("adminAuthOpen")),
    init: function init() {
      this.$watch("onVal", function (val) {
...
__webpack_require__(/*! ./chartDashboard */ "./resources/js/chartDashboard.js");
...
var diagramKonten = new Chart(document.getElementById("diagram-konten").getContext("2d"), {
  type: "doughnut",
  data: {
    labels: ["Soal Kuis", "Kategori Budaya", "Konten Budaya", "Konten Daerah"],
    datasets: [{
