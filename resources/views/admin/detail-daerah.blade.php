    ...
    <div class="sticky top-0 z-50 px-4 py-5 shadow-md bg-tertiary sm:px-6">
      ...
      <div class="flex justify-between ">
        <div>
          ...
          <p class="max-w-2xl mt-1 text-sm text-gray-500 md:text-base">
            {{ $detailData->name }}
          </p>
        </div>
      ...
      <div class="mt-5 border-t border-gray-200">
        <dl>
          ...
          <div class="px-4 py-5 bg-gray-50 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
            ...
            <dd class="mt-1 text-sm text-gray-900 md:text-base sm:mt-0 sm:col-span-2">
              {{ number_format($detailData->population) . ' Juta Jiwa' }}
            </dd>
          </div>
          <div class="px-4 py-5 bg-white sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
            <dt class="text-sm font-medium text-gray-500 md:text-base">
            ...
            <dd class="mt-1 text-sm text-gray-900 md:text-base sm:mt-0 sm:col-span-2">
              {{ number_format($detailData->size_area) }} km<sup>2</sup>
            </dd>
          </div>
          <div class="px-4 py-5 bg-gray-50 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
            <dt class="text-sm font-medium text-gray-500 md:text-base">
            ...
            <div class="col-span-2">
              <img class="object-cover p-2 border border-gray-200 rounded-md "
                src="{{ $detailData->img != 'no-img.png' ? asset('img/daerah') . '/' . $detailData->img : asset('img/no-img.png') }}"
                alt="">
            </div>
          </div>
          <div class="px-4 py-5 bg-white sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
