    ...
    <div class="px-6 py-4 border rounded-lg shadow-lg bg-tertiary border-secondary">
      <div class="gap-8 lg:flex">
        <div class="basis-1/2">
          ...
          <div class="block w-full h-full mt-6 font-semibold text-gray-600 select-none ">
        ...
        <div class="mt-6 lg:mt-0 grow">
          ...
          <button
            class="flex items-center justify-center w-full h-12 mt-6 font-semibold text-center text-white duration-200 bg-red-800 border-2 rounded-lg cursor-pointer hover:bg-red-900 hover:text-white hover:border-red-900"
            type="reset">
            Reset
          </button>
