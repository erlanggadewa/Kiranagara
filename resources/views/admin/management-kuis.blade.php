  ...
  <div>
    ...
    <div class="flex justify-end ">
      <div
        ...
        <a href="{{ route('kuis-admin.create') }}">
                  ...
                  <tr>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                      ...
                      <form id="form-delete-kuis-{{ $item->id }}" class="inline-block"
                        ...
                        @csrf
                        @method('DELETE')
                        <div class="cursor-pointer" onclick="confirmDeleteQuiz({{ $item->id }})">
                      ...
                      {{-- update --}}
                      <form class="inline-block" method="GET" action="{{ route('kuis-admin.edit', $item) }}">
                      ...
                      {{-- detail --}}
                      <form class="inline-block" method="GET" action="{{ route('kuis-admin.show', $item) }}">
                        <input type="hidden" value={{ $item->id }} name="id">
                        <button type="submit">
                          <span
...
@else
  ...
  <div class="alert alert-error">
    <div class="flex-1">
      ...
      <label>Data Kuis Kosong!</label>
    </div>
  </div>
@endif
<script>
  function confirmDeleteQuiz(id) {
    const data = document.getElementById(`form-delete-kuis-${id}`);
